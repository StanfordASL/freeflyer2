...
elif dataset_scenario == 'time' or dataset_scenario == 'time_500000' or dataset_scenario == 'time_constant' or dataset_scenario == 'time_40_60' or dataset_scenario == 'time_40_100':
    start_region = {
        'xy_low' : table['xy_low'] + robot_radius,
