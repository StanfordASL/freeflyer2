...
from dynamics.FreeflyerEnv_new import FreeflyerEnv
from decision_transformer.art_closed_loop_new import AutonomousFreeflyerTransformerMPC, ConvexMPC
import optimization.ff_scenario_new as ff
from dynamics.freeflyer_new import FreeflyerModel, ocp_no_obstacle_avoidance, compute_constraint_to_go
import time
...
def for_computation(input_iterable):
    ...
    model_oracle = input_dict['model_oracle']
    ...
    if not np.char.equal(feas_cvx,'infeasible'):
        ...
        try:
            ...
            for i in np.arange(quad_env_art.n_time_rpod):
                ...
                cvx_traj = cvxMPC.warmstart(real_obs_art, quad_env_art, rtg0=rtg_0, ctg0=0)
...
if __name__ == '__main__':
    ...
    initial_transformer_name = 'checkpoint_ff_obs_15scen_cbe_rel_ctgrtg'
