//Completed - Untested - First Iteration - Not Eigen - 1st Iteration
//Only uses arrays from std namespace
//Soorya Sridharan - 12/28/2023
//As the name implies this is a Constant Velocity/Constant 0 Acceleration Kalman Filter made with very archaic methods - FOR LOOPS
#include <iostream> 
#include <cmath>
#include <array>
