...
ff_msgs__msg__Twist2D__create()
{
  ...
  ff_msgs__msg__Twist2D * msg = (ff_msgs__msg__Twist2D *)allocator.allocate(sizeof(ff_msgs__msg__Twist2D), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ff_msgs__msg__Twist2D));
  bool success = ff_msgs__msg__Twist2D__init(msg);
  if (!success) {
...
ff_msgs__msg__Twist2D__destroy(ff_msgs__msg__Twist2D * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ff_msgs__msg__Twist2D__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ff_msgs__msg__Twist2D__Sequence__init(ff_msgs__msg__Twist2D__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ff_msgs__msg__Twist2D * data = NULL;

  if (size) {
    data = (ff_msgs__msg__Twist2D *)allocator.zero_allocate(size, sizeof(ff_msgs__msg__Twist2D), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ff_msgs__msg__Twist2D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ff_msgs__msg__Twist2D__fini(&data[i - 1]);
      }
...
ff_msgs__msg__Twist2D__Sequence__fini(ff_msgs__msg__Twist2D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ff_msgs__msg__Twist2D__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ff_msgs__msg__Twist2D__Sequence * array = (ff_msgs__msg__Twist2D__Sequence *)allocator.allocate(sizeof(ff_msgs__msg__Twist2D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ff_msgs__msg__Twist2D__Sequence__init(array, size);
  if (!success) {
...
ff_msgs__msg__Twist2D__Sequence__destroy(ff_msgs__msg__Twist2D__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ff_msgs__msg__Twist2D__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ff_msgs__msg__Twist2D__Sequence__are_equal(const ff_msgs__msg__Twist2D__Sequence * lhs, const ff_msgs__msg__Twist2D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ff_msgs__msg__Twist2D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ff_msgs__msg__Twist2D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ff_msgs__msg__Twist2D);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ff_msgs__msg__Twist2D * data =
      (ff_msgs__msg__Twist2D *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ff_msgs__msg__Twist2D__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ff_msgs__msg__Twist2D__fini(&output->data[i]);
        }
        return false;
      }
    }
