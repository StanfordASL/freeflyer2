...
{
  new (message_memory) ff_msgs::msg::Twist2DStamped(_init);
}

void Twist2DStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ff_msgs::msg::Twist2DStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Twist2DStamped_message_member_array[2] = {
  {
    ...
    offsetof(ff_msgs::msg::Twist2DStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ff_msgs::msg::Twist2DStamped, twist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Twist2DStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(ff_msgs::msg::Twist2DStamped),
...
get_message_type_support_handle<ff_msgs::msg::Twist2DStamped>()
{
  return &::ff_msgs::msg::rosidl_typesupport_introspection_cpp::Twist2DStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ff_msgs, msg, Twist2DStamped)() {
  return &::ff_msgs::msg::rosidl_typesupport_introspection_cpp::Twist2DStamped_message_type_support_handle;
}
