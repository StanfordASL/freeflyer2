...
#ifndef FF_SRVS__SRV__DETAIL__PATH_PLAN__FUNCTIONS_H_
#define FF_SRVS__SRV__DETAIL__PATH_PLAN__FUNCTIONS_H_
...
#include "ff_srvs/msg/rosidl_generator_c__visibility_control.h"

#include "ff_srvs/srv/detail/path_plan__struct.h"

/// Initialize srv/PathPlan message.
/**
...
/// Create srv/PathPlan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ff_srvs__srv__PathPlan_Request__init().
...
/// Destroy srv/PathPlan message.
/**
 * It calls
 * ff_srvs__srv__PathPlan_Request__fini()
...
/// Check for srv/PathPlan message equality.
/**
...
/// Initialize array of srv/PathPlan messages.
/**
...
/// Finalize array of srv/PathPlan messages.
/**
 * It calls
 * ff_srvs__srv__PathPlan_Request__fini()
...
/// Create array of srv/PathPlan messages.
/**
 * It allocates the memory for the array and calls
 * ff_srvs__srv__PathPlan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PathPlan messages.
/**
 * It calls
 * ff_srvs__srv__PathPlan_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PathPlan message array equality.
/**
...
/// Copy an array of srv/PathPlan messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ff_srvs__srv__PathPlan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ff_srvs
...
/**
 * It calls
 * ff_srvs__srv__PathPlan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ff_srvs
...
/**
 * It allocates the memory for the array and calls
 * ff_srvs__srv__PathPlan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ff_srvs
...
/**
 * It calls
 * ff_srvs__srv__PathPlan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FF_SRVS__SRV__DETAIL__PATH_PLAN__FUNCTIONS_H_
